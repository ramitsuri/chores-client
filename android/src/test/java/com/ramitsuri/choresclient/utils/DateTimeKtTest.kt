...
class DateTimeKtTest {
    ...
    fun testSnoozeDay1() {
        ...
        val actual =
            getNewReminderTimeSnoozeDay(now, timeZone).toInstant(TimeZone.currentSystemDefault())
    ...
    fun testSnoozeHour1() {
        val now = Instant.fromEpochMilliseconds(1651406400000) // 2022-05-01 8AM UTC -4
        val actual = getNewReminderTimeSnoozeHour(now).toInstant(TimeZone.currentSystemDefault())
